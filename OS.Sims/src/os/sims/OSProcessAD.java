...
//This is a test
	...
	public void runCPUinAD() {
		...
		if ((last != null) && last.getPCPUtimeInt() <= 1 && first != last ) {
		...
		actual = first;
		if ((actual != null) && actual.getPCPUtimeInt() <= 1) {
